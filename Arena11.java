...
public class Arena11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena11);

        citizen = findViewById(R.id.citizen11);
        citizenright = findViewById(R.id.citizenright11);
        joystickView = findViewById(R.id.joystickView11);
        cardView = findViewById(R.id.cardView11);
        answerA = findViewById(R.id.answerA11);
        answerB = findViewById(R.id.answerB11);
        answerC = findViewById(R.id.answerC11);
        answerD = findViewById(R.id.answerD11);
        question = findViewById(R.id.question11);
        golem = findViewById(R.id.golem11);

        question.setText(MainMenu.questions.get(11));
        answerA.setText(MainMenu.answers11.get(0));
        answerB.setText(MainMenu.answers11.get(1));
        answerC.setText(MainMenu.answers11.get(2));
        answerD.setText(MainMenu.answers11.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena11.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena11.this, Arena12.class);//Optional parameters
        Arena11.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena11);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct11, joystickView, golem);
        }
