...
public class Arena4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        citizen = findViewById(R.id.citizen4);
        citizenright = findViewById(R.id.citizenright4);
        joystickView = findViewById(R.id.joystickView4);
        cardView = findViewById(R.id.cardView4);
        answerA = findViewById(R.id.answerA4);
        answerB = findViewById(R.id.answerB4);
        answerC = findViewById(R.id.answerC4);
        answerD = findViewById(R.id.answerD4);
        question = findViewById(R.id.question4);
        golem = findViewById(R.id.golem4);

        question.setText(MainMenu.questions.get(4));
        answerA.setText(MainMenu.answers4.get(0));
        answerB.setText(MainMenu.answers4.get(1));
        answerC.setText(MainMenu.answers4.get(2));
        answerD.setText(MainMenu.answers4.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena4.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena4.this, Arena5.class);//Optional parameters
        Arena4.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena4);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct4, joystickView, golem);
        }
    }
