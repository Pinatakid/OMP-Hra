...
public class Arena20 extends AppCompatActivity {

    private static ImageView citizen, citizenright, youwonb, golem;
    private static JoystickView joystickView;
    private static SpringAnimation animationY2, animationY4;
    private static TextView answerA, answerB, answerC, answerD, question, youwon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena20);

        citizen = findViewById(R.id.citizen20);
        citizenright = findViewById(R.id.citizenright20);
        joystickView = findViewById(R.id.joystickView20);
        cardView = findViewById(R.id.cardView20);
        answerA = findViewById(R.id.answerA20);
        answerB = findViewById(R.id.answerB20);
        answerC = findViewById(R.id.answerC20);
        answerD = findViewById(R.id.answerD20);
        question = findViewById(R.id.question20);
        youwon = findViewById(R.id.youwon);
        youwonb = findViewById(R.id.youwonb);
        golem = findViewById(R.id.golem20);

        question.setText(MainMenu.questions.get(20));
        answerA.setText(MainMenu.answers20.get(0));
        answerB.setText(MainMenu.answers20.get(1));
        answerC.setText(MainMenu.answers20.get(2));
        answerD.setText(MainMenu.answers20.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena20.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        youwonb.setVisibility(View.VISIBLE);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct20, joystickView, golem);
        }
    }
