...
public class Arena13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena13);

        citizen = findViewById(R.id.citizen13);
        citizenright = findViewById(R.id.citizenright13);
        joystickView = findViewById(R.id.joystickView13);
        cardView = findViewById(R.id.cardView13);
        answerA = findViewById(R.id.answerA13);
        answerB = findViewById(R.id.answerB13);
        answerC = findViewById(R.id.answerC13);
        answerD = findViewById(R.id.answerD13);
        question = findViewById(R.id.question13);
        golem = findViewById(R.id.golem13);

        question.setText(MainMenu.questions.get(13));
        answerA.setText(MainMenu.answers13.get(0));
        answerB.setText(MainMenu.answers13.get(1));
        answerC.setText(MainMenu.answers13.get(2));
        answerD.setText(MainMenu.answers13.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena13.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena13.this, Arena14.class);//Optional parameters
        Arena13.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena13);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct13, joystickView, golem);
        }
    }
