...
public class Arena6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena6);

        citizen = findViewById(R.id.citizen6);
        citizenright = findViewById(R.id.citizenright6);
        joystickView = findViewById(R.id.joystickView6);
        cardView = findViewById(R.id.cardView6);
        answerA = findViewById(R.id.answerA6);
        answerB = findViewById(R.id.answerB6);
        answerC = findViewById(R.id.answerC6);
        answerD = findViewById(R.id.answerD6);
        question = findViewById(R.id.question6);
        golem = findViewById(R.id.golem6);

        question.setText(MainMenu.questions.get(6));
        answerA.setText(MainMenu.answers6.get(0));
        answerB.setText(MainMenu.answers6.get(1));
        answerC.setText(MainMenu.answers6.get(2));
        answerD.setText(MainMenu.answers6.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena6.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena6.this, Arena7.class);//Optional parameters
        Arena6.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena6);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct6, joystickView, golem);
        }
    }
