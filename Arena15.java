...
public class Arena15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena15);

        citizen = findViewById(R.id.citizen15);
        citizenright = findViewById(R.id.citizenright15);
        joystickView = findViewById(R.id.joystickView15);
        cardView = findViewById(R.id.cardView15);
        answerA = findViewById(R.id.answerA15);
        answerB = findViewById(R.id.answerB15);
        answerC = findViewById(R.id.answerC15);
        answerD = findViewById(R.id.answerD15);
        question = findViewById(R.id.question15);
        golem = findViewById(R.id.golem15);

        question.setText(MainMenu.questions.get(15));
        answerA.setText(MainMenu.answers15.get(0));
        answerB.setText(MainMenu.answers15.get(1));
        answerC.setText(MainMenu.answers15.get(2));
        answerD.setText(MainMenu.answers15.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena15.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena15.this, Arena16.class);//Optional parameters
        Arena15.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena15);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct15, joystickView, golem);
        }
    }
