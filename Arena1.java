...
public class Arena1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        citizen = findViewById(R.id.citizen1);
        citizenright = findViewById(R.id.citizenright1);
        joystickView = findViewById(R.id.joystickView1);
        cardView = findViewById(R.id.cardView1);
        answerA = findViewById(R.id.answerA1);
        answerB = findViewById(R.id.answerB1);
        answerC = findViewById(R.id.answerC1);
        answerD = findViewById(R.id.answerD1);
        question = findViewById(R.id.question1);
        golem = findViewById(R.id.golem);


        question.setText(MainMenu.questions.get(1));
        answerA.setText(MainMenu.answers1.get(0));
        answerB.setText(MainMenu.answers1.get(1));
        answerC.setText(MainMenu.answers1.get(2));
        answerD.setText(MainMenu.answers1.get(3));

        playerMoves(citizen, citizenright, joystickView, 1920);
    }
    public void mapMove() {
        joystickView.setFixedCenter(true);
        Intent myIntent = new Intent(Arena1.this, Arena2.class);//Optional parameters
        Arena1.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena1);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct1, joystickView, golem);
        }
