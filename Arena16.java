...
public class Arena16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena16);

        citizen = findViewById(R.id.citizen16);
        citizenright = findViewById(R.id.citizenright16);
        joystickView = findViewById(R.id.joystickView16);
        cardView = findViewById(R.id.cardView16);
        answerA = findViewById(R.id.answerA16);
        answerB = findViewById(R.id.answerB16);
        answerC = findViewById(R.id.answerC16);
        answerD = findViewById(R.id.answerD16);
        question = findViewById(R.id.question16);
        golem = findViewById(R.id.golem16);

        question.setText(MainMenu.questions.get(16));
        answerA.setText(MainMenu.answers16.get(0));
        answerB.setText(MainMenu.answers16.get(1));
        answerC.setText(MainMenu.answers16.get(2));
        answerD.setText(MainMenu.answers16.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena16.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena16.this, Arena17.class);//Optional parameters
        Arena16.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena16);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct16, joystickView, golem);
        }
    }
