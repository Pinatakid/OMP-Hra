...
public class Arena10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena10);

        citizen = findViewById(R.id.citizen10);
        citizenright = findViewById(R.id.citizenright10);
        joystickView = findViewById(R.id.joystickView10);
        cardView = findViewById(R.id.cardView10);
        answerA = findViewById(R.id.answerA10);
        answerB = findViewById(R.id.answerB10);
        answerC = findViewById(R.id.answerC10);
        answerD = findViewById(R.id.answerD10);
        question = findViewById(R.id.question10);
        golem = findViewById(R.id.golem10);

        question.setText(MainMenu.questions.get(10));
        answerA.setText(MainMenu.answers10.get(0));
        answerB.setText(MainMenu.answers10.get(1));
        answerC.setText(MainMenu.answers10.get(2));
        answerD.setText(MainMenu.answers10.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena10.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena10.this, Arena11.class);//Optional parameters
        Arena10.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena10);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct10, joystickView, golem);
        }
    }
