...
public class Arena7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena7);

        citizen = findViewById(R.id.citizen7);
        citizenright = findViewById(R.id.citizenright7);
        joystickView = findViewById(R.id.joystickView7);
        cardView = findViewById(R.id.cardView7);
        answerA = findViewById(R.id.answerA7);
        answerB = findViewById(R.id.answerB7);
        answerC = findViewById(R.id.answerC7);
        answerD = findViewById(R.id.answerD7);
        question = findViewById(R.id.question7);
        golem = findViewById(R.id.golem7);

        question.setText(MainMenu.questions.get(7));
        answerA.setText(MainMenu.answers7.get(0));
        answerB.setText(MainMenu.answers7.get(1));
        answerC.setText(MainMenu.answers7.get(2));
        answerD.setText(MainMenu.answers7.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena7.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena7.this, Arena8.class);//Optional parameters
        Arena7.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena7);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct7, joystickView, golem);
        }
    }
