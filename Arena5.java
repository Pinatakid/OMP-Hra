...
public class Arena5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena5);

        citizen = findViewById(R.id.citizen5);
        citizenright = findViewById(R.id.citizenright5);
        joystickView = findViewById(R.id.joystickView5);
        cardView = findViewById(R.id.cardView5);
        answerA = findViewById(R.id.answerA5);
        answerB = findViewById(R.id.answerB5);
        answerC = findViewById(R.id.answerC5);
        answerD = findViewById(R.id.answerD5);
        question = findViewById(R.id.question5);
        golem = findViewById(R.id.golem5);

        question.setText(MainMenu.questions.get(5));
        answerA.setText(MainMenu.answers5.get(0));
        answerB.setText(MainMenu.answers5.get(1));
        answerC.setText(MainMenu.answers5.get(2));
        answerD.setText(MainMenu.answers5.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena5.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena5.this, Arena6.class);//Optional parameters
        Arena5.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena5);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct5, joystickView, golem);
        }
    }
