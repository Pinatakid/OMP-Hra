...
public class Arena9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena9);

        citizen = findViewById(R.id.citizen9);
        citizenright = findViewById(R.id.citizenright9);
        joystickView = findViewById(R.id.joystickView9);
        cardView = findViewById(R.id.cardView9);
        answerA = findViewById(R.id.answerA9);
        answerB = findViewById(R.id.answerB9);
        answerC = findViewById(R.id.answerC9);
        answerD = findViewById(R.id.answerD9);
        question = findViewById(R.id.question9);
        golem = findViewById(R.id.golem9);

        question.setText(MainMenu.questions.get(9));
        answerA.setText(MainMenu.answers9.get(0));
        answerB.setText(MainMenu.answers9.get(1));
        answerC.setText(MainMenu.answers9.get(2));
        answerD.setText(MainMenu.answers9.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena9.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena9.this, Arena10.class);//Optional parameters
        Arena9.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena9);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct9, joystickView, golem);
        }
    }
