...
public class Arena8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena8);

        citizen = findViewById(R.id.citizen8);
        citizenright = findViewById(R.id.citizenright8);
        joystickView = findViewById(R.id.joystickView8);
        cardView = findViewById(R.id.cardView8);
        answerA = findViewById(R.id.answerA8);
        answerB = findViewById(R.id.answerB8);
        answerC = findViewById(R.id.answerC8);
        answerD = findViewById(R.id.answerD8);
        question = findViewById(R.id.question8);
        golem = findViewById(R.id.golem8);

        question.setText(MainMenu.questions.get(8));
        answerA.setText(MainMenu.answers8.get(0));
        answerB.setText(MainMenu.answers8.get(1));
        answerC.setText(MainMenu.answers8.get(2));
        answerD.setText(MainMenu.answers8.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena8.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena8.this, Arena9.class);//Optional parameters
        Arena8.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena8);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct8, joystickView, golem);
        }
    }
