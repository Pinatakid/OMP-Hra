...
public class Arena17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena17);

        citizen = findViewById(R.id.citizen17);
        citizenright = findViewById(R.id.citizenright17);
        joystickView = findViewById(R.id.joystickView17);
        cardView = findViewById(R.id.cardView17);
        answerA = findViewById(R.id.answerA17);
        answerB = findViewById(R.id.answerB17);
        answerC = findViewById(R.id.answerC17);
        answerD = findViewById(R.id.answerD17);
        question = findViewById(R.id.question17);
        golem = findViewById(R.id.golem17);

        question.setText(MainMenu.questions.get(17));
        answerA.setText(MainMenu.answers17.get(0));
        answerB.setText(MainMenu.answers17.get(1));
        answerC.setText(MainMenu.answers17.get(2));
        answerD.setText(MainMenu.answers17.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena17.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena17.this, Arena18.class);//Optional parameters
        Arena17.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena17);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct17, joystickView, golem);
        }
    }
