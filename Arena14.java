...
public class Arena14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena14);

        citizen = findViewById(R.id.citizen14);
        citizenright = findViewById(R.id.citizenright14);
        joystickView = findViewById(R.id.joystickView14);
        cardView = findViewById(R.id.cardView14);
        answerA = findViewById(R.id.answerA14);
        answerB = findViewById(R.id.answerB14);
        answerC = findViewById(R.id.answerC14);
        answerD = findViewById(R.id.answerD14);
        question = findViewById(R.id.question14);
        golem = findViewById(R.id.golem14);

        question.setText(MainMenu.questions.get(14));
        answerA.setText(MainMenu.answers14.get(0));
        answerB.setText(MainMenu.answers14.get(1));
        answerC.setText(MainMenu.answers14.get(2));
        answerD.setText(MainMenu.answers14.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena14.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena14.this, Arena15.class);//Optional parameters
        Arena14.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena14);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct14, joystickView, golem);
        }
    }
}