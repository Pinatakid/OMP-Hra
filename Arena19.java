...
public class Arena19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena19);

        citizen = findViewById(R.id.citizen19);
        citizenright = findViewById(R.id.citizenright19);
        joystickView = findViewById(R.id.joystickView19);
        cardView = findViewById(R.id.cardView19);
        answerA = findViewById(R.id.answerA19);
        answerB = findViewById(R.id.answerB19);
        answerC = findViewById(R.id.answerC19);
        answerD = findViewById(R.id.answerD19);
        question = findViewById(R.id.question19);
        golem = findViewById(R.id.golem19);

        question.setText(MainMenu.questions.get(19));
        answerA.setText(MainMenu.answers19.get(0));
        answerB.setText(MainMenu.answers19.get(1));
        answerC.setText(MainMenu.answers19.get(2));
        answerD.setText(MainMenu.answers19.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena19.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena19.this, Arena20.class);//Optional parameters
        Arena19.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena19);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct19, joystickView, golem);
        }
    }
