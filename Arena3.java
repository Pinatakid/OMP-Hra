...
public class Arena3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        citizen = findViewById(R.id.citizen3);
        citizenright = findViewById(R.id.citizenright3);
        joystickView = findViewById(R.id.joystickView3);
        cardView = findViewById(R.id.cardView3);
        answerA = findViewById(R.id.answerA3);
        answerB = findViewById(R.id.answerB3);
        answerC = findViewById(R.id.answerC3);
        answerD = findViewById(R.id.answerD3);
        question = findViewById(R.id.question3);
        golem = findViewById(R.id.golem3);

        question.setText(MainMenu.questions.get(3));
        answerA.setText(MainMenu.answers3.get(0));
        answerB.setText(MainMenu.answers3.get(1));
        answerC.setText(MainMenu.answers3.get(2));
        answerD.setText(MainMenu.answers3.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena3.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {joystickView.setFixedCenter(true);
        Intent myIntent = new Intent(Arena3.this, Arena4.class);//Optional parameters
        Arena3.this.startActivity(myIntent);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct3, joystickView, golem);
        }
    }
