...
public class Arena12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena12);

        citizen = findViewById(R.id.citizen12);
        citizenright = findViewById(R.id.citizenright12);
        joystickView = findViewById(R.id.joystickView12);
        cardView = findViewById(R.id.cardView12);
        answerA = findViewById(R.id.answerA12);
        answerB = findViewById(R.id.answerB12);
        answerC = findViewById(R.id.answerC12);
        answerD = findViewById(R.id.answerD12);
        question = findViewById(R.id.question12);
        golem = findViewById(R.id.golem12);

        question.setText(MainMenu.questions.get(12));
        answerA.setText(MainMenu.answers12.get(0));
        answerB.setText(MainMenu.answers12.get(1));
        answerC.setText(MainMenu.answers12.get(2));
        answerD.setText(MainMenu.answers12.get(3));
...
//                    }
        ...
        citizenright.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Arena12.this, "X axis is " + location[0] + " and Y axis is " + location[1], Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                }
    ...
    public void mapMove() {
        ...
        Intent myIntent = new Intent(Arena12.this, Arena13.class);//Optional parameters
        Arena12.this.startActivity(myIntent);
        finishActivity(R.layout.activity_arena12);
    ...
    public void actionQuiz() {
        if(citizenright.getX()==golem.getX() && citizenright.getX()==golem.getX() && citizenright.getY()>700f) {
            game.quizTest(answerC, answerD, answerA, answerB, cardView, MainMenu.correct12, joystickView, golem);
        }
    }
}